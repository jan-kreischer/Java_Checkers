...
public class Board {
    ...
    public static Piece[][] sendBoard(){
        return board;
    }

    public static void getLastBoard(){
        Piece[][] boardCopy = BoardLog.sendLatest();
...
//                int randColumn = random.nextInt(8);
//                int randRow = Board.getRandomRow(randColumn);
//                Piece redPiece = new Piece(Color.RED, randColumn, randRow, State.PAWN, 0);
//                board[randRow][randColumn] = redPiece;
//                redPiece.updatePiece(randRow, randColumn);
//            }
//            for (int i = 0; i < 11; i = i + 1) {
//                int randColumn = random.nextInt(8);
//                int randRow = Board.getRandomRow(randColumn);
//                Piece whitePiece = new Piece(Color.WHITE, randColumn, randRow, State.PAWN, 0);
//                board[randRow][randColumn] = whitePiece;
//                whitePiece.updatePiece(randRow, randColumn);
//            }
//        } else {
//            for (int i = 0; i < 11; i = i + 1) {
//                int randColumn = random.nextInt(8);
...
//    }
//
//    public static int getRandomRow(int randColumn) {
//        Random random = new Random();
